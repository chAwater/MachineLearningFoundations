...
其实之前就讲过这个概念，比如特征工程，把原始的数据（像素）做一些操作（比如找出对称性、密度等）得到一些具有物理意义的特征，其实这就是一种特征转换。

### 非线性变换的代价

为了如此强大的特征转换，我们要付出什么样的代价呢？
...
这是意味着需要非常巨大的计算和存储量，通常问题中的 _d_ 就比较大了，因此对于越大的 _Q_ 这个数字越可怕。
